...
<table id="mt" class="rounded-corner" summary="2007 Major IT Companies' Profit">
    <thead>
        ...
        <tfoot>
    	<tr>
        	<td colspan="10" style="width:835px;"class="rounded-foot-left"><em>You have made <?php echo $_smarty_tpl->tpl_vars['userRecordCount']->value;?>
 requests.</em></td>
...
<?php $_tmp1=ob_get_clean();?><?php if ($_tmp1=='supervisor'){?>
			...
			<table class="rounded-corner" summary="2007 Major IT Companies' Profit">
				...
				<tfoot>
				<tr>
					<td colspan="10" style="width:835px;" class="rounded-foot-left"><em>You have <?php echo $_smarty_tpl->tpl_vars['supervisorRecordCount']->value;?>
 pending requests.</em></td>
					<td class="rounded-foot-right">&nbsp;</td>
