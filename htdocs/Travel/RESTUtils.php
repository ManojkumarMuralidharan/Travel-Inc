...
public $data;
	...
	//echo 'Query-Str'.$_SERVER['QUERY_STRING'].'</br>';;
	...
	{
		$url=RestUtils::getFullUrl($_SERVER);
		//echo RestUtils::test();
		//echo "url=".$url;
		// get our verb
		...
		$return_obj->setRequestVars($this->data);

		if(isset($this->data['data']))
		{
			// translate the JSON to an Object for use however you want
			$return_obj->setData(json_decode($this->data['data']));
		}
		return $return_obj;
	}
